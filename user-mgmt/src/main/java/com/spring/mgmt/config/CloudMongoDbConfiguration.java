package com.spring.mgmt.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import com.spring.mgmt.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.spring.mgmt.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.spring.mgmt.config.dbmigrations");
